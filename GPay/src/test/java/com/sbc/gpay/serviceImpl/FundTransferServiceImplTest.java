...
class FundTransferServiceImplTest {
	...
	void userCheckTest() {
		...
		when(fundTransferServiceImpl.fundTransferByPhone(fromPhone, toPhone,amount)).thenReturn(response);
		response.setStatusCode(200);
				  
		ResponseDto actua6=fundTransferServiceImpl.fundTransferByPhone(fromPhone,toPhone, amount); 
		actua6.setStatusCode(200);
		assertEquals(200, actua6.getStatusCode());
